<x-layout-admin>
    ...
    <!-- Statistik card diatas , jumlah kamera tersedia dan disewa-->
    <div class="bg-gray-200 pt-4 fixed z-50 mt-0.4 w-full">
        <div class="grid grid-cols-4 gap-2">
            <div class="p-3 px-4 bg-white border-gray-200 shadow-md rounded-lg w-full mb-4">
                ...
                <h1 class="text-3xl font-bold tracking-tight mb-1">{{ $kameraTersedia }}</h1>
            </div>
            <div class="p-3 px-4 bg-white border-gray-200 shadow-md rounded-lg w-full mb-4">
        ...
        <!-- Statistik card diatas , jumlah kamera tersedia dan disewa endd-->
    ...
    <!-- Tabel unit kamera mulai dari siniiii-->
                ...
                <tbody>
                    @foreach($barang as $index => $item)
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-4 py-3 flex item-center justify-center ">
    ...
    <!-- Tabel unit kamera kelar sampee siniiii-->
