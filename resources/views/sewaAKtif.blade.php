<x-layout-admin>
    ...
    {{-- statistik card di bagian kiri atasss --}}
    ...
    {{-- statistik card di bagian kiri atasss end--}}
                                ...
                                <td class="px-4 py-3 flex items-center justify-end ">
                                    ...
                                    <div id="apple-imac-{{ $key }}-dropdown" class="hidden z-10 w-26 bg-white rounded divide-y divide-gray-100 shadow">
                                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <form action="{{ route('pesanan.selesai', $item->id) }}" method="POST" onsubmit="return confirm('Yakin pesanan ini sudah selesai ?, pastikan penyewa sudah mengembalikan barang dan membayar denda jika ada.')">
                                                    @csrf
                                                    @method('PATCH')
